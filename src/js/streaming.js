...
const bigButtonPause = '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-player-pause" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(246,24,66)" fill="rgb(246,24,66)" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z" /><path d="M14 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z" /></svg>';
const bigButtonPlay = '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-player-play" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(246,24,66)" fill="rgb(246,24,66)" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 4v16l13 -8z" /></svg>';
...
function initGPT() {
  ...
  googletag.cmd.push(function() {
    ...
    window.slot4 = googletag.defineSlot("/21799830913/Oye", [728, 90],'ad-slot4').defineSizeMapping(mapping4).addService(googletag.pubads());
    window.slot41 = googletag.defineSlot("/21799830913/Oye", [320, 50],'ad-slot41').defineSizeMapping(mapping41).addService(googletag.pubads());
    window.slot42 = googletag.defineSlot("/21799830913/Oye", [728, 90],'ad-slot42').defineSizeMapping(mapping42).addService(googletag.pubads());
    window.slot421 = googletag.defineSlot("/21799830913/Oye", [320, 50],'ad-slot421').defineSizeMapping(mapping421).addService(googletag.pubads());
    window.slot5 = googletag.defineSlot("/21799830913/Oye", [300, 600],'ad-slot5').defineSizeMapping(mapping5).addService(googletag.pubads());
    window.slot6 = googletag.defineSlot("/21799830913/Oye", [970, 90],'ad-slot6').defineSizeMapping(mapping6).addService(googletag.pubads());
